"""
Django settings for bulletlist_report project.
...
ROOT_URLCONF = 'bulletlist_report.urls'
...
WSGI_APPLICATION = 'bulletlist_report.wsgi.application'
...
AUTH_USER_MODEL = 'user.models.UserProfile'
